...
set(handles.VID,'ROIPosition', handles.roi);
disp('click to set margins');k = waitforbuttonpress;
...
% RUN
disp('running...');
linescan_run(handles.VID,handles.AO,handles.vidparams,handles.aoparams,handles.meanbg,handles.collimits);
